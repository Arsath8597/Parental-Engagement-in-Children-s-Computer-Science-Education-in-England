...
const Profile = () => {
  return (
    <div className="w-full max-w-[400px] h-[220px] mt-10 bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 flex items-center justify-between hover:scale-[1.02] transition-transform duration-300 shadow-xl">
